        ...
        GuiBuilder.show(player, Text.CONFIGURE_TITLE_GENERAL.format().toString(), arrayOf(
                ...
                onInit = { index ->
                    ...
                    when (index.section) {
                        ...
                        'l' -> GuiBuilder.ItemSlot(setQty(ItemStack(Material.SKULL_ITEM), settings.lives))
        ...
        GuiBuilder.show(player, Text.CONFIGURE_TITLE_BLOCKS.format().toString(), arrayOf(
                ...
                onInit = { index ->
                    when (index.section) {
                        ...
                        'p' -> GuiBuilder.ItemSlot(Material.YELLOW_FLOWER)
                        ...
                        'c' -> {
                            if (index.secIndex == selected) {
                                GuiBuilder.ItemSlot(BukkitUtils.makeStainedGlassPane(DyeColor.YELLOW))
                                        .unMovable().displayName(" ")
                            } else {
                                GuiBuilder.blank
                            }
                ...
                onInit = { index ->
                    when (index.section) {
                        ...
                        'S' -> {
                            val color = when {
                                // selected
                                index.secIndex == slot -> DyeColor.YELLOW
                                // nothing added
                            ...
                            GuiBuilder.ItemSlot(BukkitUtils.makeConcrete(color))
