...
enum class Text(path: String) : Contexted {
    ...
    START_GAME_ALREADY_STARTED("command.start.already-started"),
    START_GAME_ALREADY_COUNTING("command.start.already-counting"),
    ...
    JOIN_ADDED_TO_LOBBY("command.join.added-to-lobby"),
    JOIN_ADDED_DIRECT("command.join.added-direct"),
