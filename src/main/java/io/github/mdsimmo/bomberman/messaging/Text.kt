...
enum class Text(path: String) : Contexted {
    ...
    CREATE_FLAG_SCHEMA("command.create.flags.schem.description"),
    CREATE_FLAG_WAND("command.create.flags.wand.description"),
    CREATE_FLAG_SCHEMA_EXT("command.create.flags.schem.ext"),
