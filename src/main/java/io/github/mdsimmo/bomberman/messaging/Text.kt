...
enum class Text(path: String) : Contexted {
    ...
    CONFIGURE_DESTRUCTIBLE("command.configure.destructible.name"),
    CONFIGURE_DESTRUCTIBLE_DESC("command.configure.destructible.description"),
    CONFIGURE_INDESTRUCTIBLE("command.configure.indestructible.name"),
    CONFIGURE_INDESTRUCTIBLE_DESC("command.configure.indestructible.description"),
    CONFIGURE_PASS_KEEP("command.configure.pass-keep.name"),
    CONFIGURE_PASS_KEEP_DESC("command.configure.pass-keep.description"),
    CONFIGURE_PASS_DESTROY("command.configure.pass-destroy.name"),
    CONFIGURE_PASS_DESTROY_DESC("command.configure.pass-destroy.description"),
    CONFIGURE_LIVES("command.configure.lives"),
    CONFIGURE_FUSE_TICKS("command.configure.fuse-ticks"),
    CONFIGURE_FIRE_TICKS("command.configure.fire-ticks"),
    CONFIGURE_IMMUNITY_TICKS("command.configure.immunity-ticks"),
    CONFIGURE_TNT_BLOCK("command.configure.tnt-block"),
    CONFIGURE_FIRE_ITEM("command.configure.fire-item"),
