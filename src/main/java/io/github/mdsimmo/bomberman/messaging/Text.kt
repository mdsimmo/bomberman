...
enum class Text(path: String) : Contexted {
    ...
    NEWGAME_NAME("command.newgame.name"),
    NEWGAME_DESCRIPTION("command.newgame.description"),
    NEWGAME_USAGE("command.newgame.usage"),
    NEWGAME_EXAMPLE("command.newgame.example"),
    NEWGAME_EXTRA("command.newgame.extra"),
    NEWGAME_GL_EXISTS("command.newgame.gl-exists"),
    NEWGAME_NEED_SELECTION("command.newgame.need-selection"),
    NEWGAME_SUCCESS("command.newgame.success"),
    NEWGAME_ERROR("command.newgame.error"),
    NEWGAME_SCHEMA_NOT_FOUND("command.newgame.schema-not-found"),
    NEWGAME_FLAG_PLUGIN("command.newgame.flags.p.description"),
    NEWGAME_FLAG_SCHEMA("command.newgame.flags.f.description"),
    NEWGAME_FLAG_SKIP_AIR("command.newgame.flags.a.description"),
    NEWGAME_FLAG_VOID_TO_AIR("command.newgame.flags.v.description"),
    NEWGAME_FLAG_PLUGIN_EXT("command.newgame.flags.p.ext"),
    NEWGAME_FLAG_SCHEMA_EXT("command.newgame.flags.f.ext"),
    NEWLOBBY_NAME("command.newlobby.name"),
    NEWLOBBY_DESCRIPTION("command.newlobby.description"),
    NEWLOBBY_USAGE("command.newlobby.usage"),
    NEWLOBBY_EXAMPLE("command.newlobby.example"),
    NEWLOBBY_EXTRA("command.newlobby.extra"),
    NEWLOBBY_SUCCESS("command.newlobby.success"),
    NEWLOBBY_GL_EXISTS("command.newlobby.gl-exists"),
    ...
    LIST_NAME("command.list.name"),
    LIST_DESCRIPTION("command.list.description"),
    LIST_USAGE("command.list.usage"),
    LIST_EXAMPLE("command.list.example"),
    LIST_EXTRA("command.list.extra"),
    LIST_RESULT("command.list.result"),
    ...
    INFO_RESULT("command.info.result"),
